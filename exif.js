(function() {
    ...
    function getImageData(img, callback) {
        ...
        } else if (img instanceof FileReader) {
            handleBinaryFile(img.result);
        }
    }
            ...
            for (tag in gpsData) {
                switch (tag) {
                    case "GPSVersionID" :
                        ...
                        break;
                    case "GPSLatitude" :
                        gpsData[tag] = ConvertDMSToDD(gpsData[tag][0], gpsData[tag][1], gpsData[tag][2], gpsData['GPSLatitudeRef']);

                        break;
                    case "GPSLongitude" :
                        gpsData[tag] = ConvertDMSToDD(gpsData[tag][0], gpsData[tag][1], gpsData[tag][2], gpsData['GPSLongitudeRef']);
                        break;
                }
